...
npm install next@15.2.4 next-intl@4.0.2 react@18.2.0 react-dom@18.2.0 @radix-ui/react-slot@1.0.2 @radix-ui/react-dialog@1.0.5 class-variance-authority@0.7.0 clsx@2.0.0 tailwind-merge@2.2.0 tailwindcss-animate@1.0.7 lucide-react@0.323.0
