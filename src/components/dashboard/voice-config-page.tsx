      ...
      <DashboardContent>
        ...
        <DashboardMain>
          <div className="space-y-6">
            <VoiceAIConfigSection title="Sélection de voix">
              <p className="text-sm text-muted-foreground mb-6">
                Choisissez la voix qui sera utilisée pour les entretiens automatisés
              </p>
                ...
                {voices.map((voice) => (
                  ...
                  >
                    ...
                    <div className="flex space-x-2">
                      ...
                      >
                        {isPlaying && selectedVoice === voice.id ? 'Lecture...' : 'Écouter'}
                      </Button>
                      <Button 
                        ...
                        onClick={() => selectVoice(voice.id)}
                      >
                        {selectedVoice === voice.id ? 'Sélectionnée' : 'Sélectionner'}
                      </Button>
                    </div>
                  </div>
                ))}
